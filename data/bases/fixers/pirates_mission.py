...
if (fixers.checkSaveValue(playernum,"pirate_mission1",0)):
    ...
    Base.Message(_("Great! Your cargo has already been transported to your ship. Fly carefully to the #55fffftingvallir#000000 system and talk to him when the contraband run is complete."))
    ...
    Base.Message(_("We have uploaded the coordinates to where we have last seen the merchant docked. Your nav computer will automatically autopilot to those coordinates around the planet.  Once he is destroyed, tractor in all of the cargo and bring it to a base that will jump into this system soon."))
    ...
    Base.Message(_("Destroy all of the enemies attacking this base and come back to me when the battle is over. After that, I will give you all of your long deserved money"))
    VS.LoadMission ("defend/pirates/pirate_msision4.mission")
    #load mission 4
else:
    Base.message (_("Yes about what?"))
