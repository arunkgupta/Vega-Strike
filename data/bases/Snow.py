...
Base.Comp (room0, 'my_comp_id', -0.765, -0.35, .2578906, 0.80833, _('Mission Computer'), _('Missions News Info'))
Base.Comp (room0, 'my_comp_id', -0.5, -0.6, 0.3, 0.3, _('Trade Cargo'), _('Cargo Info '))
...
Base.Comp (room3, 'my_comp_id', 0, 0.3, 0.3, 0.3, _('Upgrade Weapons'), _('Upgrade Info'))
