...
room0 = Base.Room (_('Landing Platform'))
room1 = Base.Room (_('Mission Room'))
room2 = Base.Room (_('Main Concourse'))
room3 = Base.Room (_('Shopping Mall'))
...
Base.Comp (room1, 'missioncomp', 0.2775, -0.28, 0.7175, 0.503333, _('Mission Computer'), _('Missions News'))
...
Base.Comp (room3, 'upg', -0.3625, -0.726667, 0.2925, 1.72, _('Upgrade Ship'), _('Upgrade Info'))
