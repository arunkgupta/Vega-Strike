...
def MakeBar (room,time_of_day='_day',bartext='bases/bartender_default.py', BaseTexture="bases/generic/bar"):
    ...
    Base.Python (bar, 'talk', -0.138672, -0.127604, 0.306641, 0.341146, _('Talk to the Bartender'),bartext,0)
    Base.Link (bar, 'Back', -0.998047, -0.997396, 2, 0.28125, _('Exit the Bar'), room)
    Base.Comp (bar, 'newscomp', 0.505859, 0.153646, 0.248047, 0.328125, _('GNN News'), 'News')
