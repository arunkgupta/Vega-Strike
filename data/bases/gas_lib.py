...
def MakeGas (time_of_day='_day'):
    ...
    Base.Comp (room1, 'Computer', -1, -0.8, .2578906, 0.80833, _('Computer'), 'Cargo Upgrade Info ShipDealer News Missions')
    Base.LaunchPython (room1, 'launch','bases/launch_music.py', -0.4, 0.1, 0.5, 0.3, _('Launch Your Ship')) #minx, miny, width, height
    return room1
