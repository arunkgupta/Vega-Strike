...
class quest_rogue_militia (quest.quest):
    def __init__ (self):
        ...
        VS.IOmessage (0,"Extortionist","all",_("This is the milita: You must pay toll to pass through these parts"))
        VS.IOmessage (0,"Extortionist","all",_("Power down your engines for 10 seconds and allow us to remove 2000 credits"))
        VS.IOmessage (5,"Extortionist","all",_("Those pirates who do not reduce speed will be shot"))
    ...
    def deductToll(self,playa):
        ...
        VS.IOmessage (0,"Extortionist","all",_("We appreciate your donation and wish you safe passage through this system!"))
        VS.IOmessage (3,"Extortionist","all",_("Thank you, come again!"))
    ...
    def Execute (self):
        ...
        if (VS.GetGameTime()-self.gametime>10 and self.stage==0):
            ...
            if (self.ZeroVel(playa)):
                ...
                for un in self.militia:
                    un.SetTarget(playa)
                VS.IOmessage(0,"Extortionist","all",_("Ok you asked for it! Die scoundrel!"))
        if (self.stage==1):
            if (len (self.militia)==0):
                VS.IOmessage (0,"Extortionist","all",_("*@&* taking work from honest securme($*@"))
                VS.IOmessage(0,"game","news",_("ROGUE SECURITY FORCES CRUSHED:  With the bulk of the Confederate Navy deployed in the war against the Aera, the protection and defense of civilian trade lines have been left to local militias in many systems. Recent events have proven, though, that some of these militias walk a very fine line between enforcing the law and breaking it. In the Heinlein System, the militia began charging outrageous toll fees for passage through the system. On those occasions when their demands weren't met, they opened fire. This prompted the Navy to dispatch the HCS Hangzhou to the system, and today the cruiser finally reported arresting the last member of the rogue security forces."))
