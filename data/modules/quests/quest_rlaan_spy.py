...
class quest_rlaan_spy (quest.quest):
    ...
    def SignificantsNear(self,significant):
        if (significant.isJumppoint()):
            ...
            VS.IOmessage (0,"game","all",_("[Computer] Target detected matching engine signature reported for rlaan spy in %s") % self.sysfile)
            VS.IOmessage (0,"game","all",_("[Computer] Confed was hunting this target..."));
